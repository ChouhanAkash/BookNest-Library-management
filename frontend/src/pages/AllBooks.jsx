...
function AllBooks() {
  ...
  const limit = 6;
  const no_of_pages = Math.ceil(books.length/limit)
  const showBooks = books.slice(limit*(page-1),limit*(page))
          ...
          <div className="max-w-7xl mx-auto px-4 py-10">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
              <div className="relative w-full md:w-1/2">
                ...
                <input className="w-full pl-4 pr-10 py-2 border border-gray-300 rounded-full shadow focus:ring-2 focus:ring-[#01BFBD] focus:outline-none" />
              </div>
            </div>
